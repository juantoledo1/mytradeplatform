  ...
  return (
    <div className={styles["details"]}>
      ...
      <div className={styles["details__row"]}>
            ...
            {filteredTags
              ...
              .map((tag) => (
                <div
                  ...
                  onClick={() =>
                    selectedTags.length < 3 && handleTagSelect(tag)
                  }
                >
                  {tag.value}
                </div>
        ...
        <label className={classNames(styles["input__outer"], styles["big"])}>
          <p>
            Estimated Value (This will help people only offer you Items of
            similar value)
          </p>
          <FormField
      ...
      <div className={styles["details__title"]}>
        ...
        <button type="button" onClick={(e) => {
          e.preventDefault();
          alert("Shipping details help: Please provide accurate dimensions and weight for your item to ensure proper shipping calculations.");
        }}>{infoIcon}</button>
      </div>
      <div className={styles["details__row"]}>
        <label className={styles["input__outer"]}>
      ...
      <p>
        Please input accurate package dimensions and weight. If the carrier
        makes a shipping adjustment, your MyTradePlatform wallet will be charged the
        additional fee.
        <br />
        <br />
        MyTradePlatform will file a dispute for any carrier adjustments that may be
        wrong or accidental.
      </p>
      <br />
      <br />
